...
<a href="{{route('new-article')}}" class="sm:hidden absolute fixed z-50 w-12 h-12 bg-green-300 rounded-full flex items-center justify-around shadow-outline" style="bottom:50px; right:30px; position:fixed;"><svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-white"><path d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg></a>
@endsection