...
<div class="container mt-6">
    <h1 class="mx-auto sm:text-center mb-3 text-xl font-semibold text-gray-600 mt-3">Chapisha Shairi Lako</h1>
        @if (session('error'))
    ...
    <div class="form-container bg-white shadow-sm rounded sm:w-1/2 sm:mx-auto">
        <form class="p-4 text-lg" action="{{route('store-poem')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <label for="poem_cover" class="text-sm block text-gray-600"
                    >Picha</label
                >
                <input
                    type="file"
